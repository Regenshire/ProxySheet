...
var cardFormat = "NoBleed";		// "MPC" for MPC formatted files with 6mm bleed, "NoBleed" for files available on Scryfall that have no bleed.
var exportSingles = true;
var exportAddBleed = "Black";		// When Exporting NoBleed cards you can optionally add a Black bleed to make them MPC sized cards
