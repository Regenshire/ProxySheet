...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  saveUserConfig: (folderName, configName, config) => ipcRenderer.invoke('save-user-config', { folderName, configName, config }),
  listUserConfigFolders: () => ipcRenderer.invoke('list-user-config-folders'),
  ...
  buildBatchJsx: (filePaths, config, includePath, isBackPage, sheetPageNum, pdfExportPath, outputFile, nextConfigPath) => ipcRenderer.invoke('build-batch-jsx', filePaths, config, includePath, isBackPage, sheetPageNum, pdfExportPath, outputFile, nextConfigPath),
