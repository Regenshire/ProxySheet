...
// PDF EXPORT OPTIONS
var outputPDF = true;			// Set to True if you want to output a PDF file into the PDFOutput directory
var pdfExportPreset = "Press Quality"	// Options include "High Quality Print", "Press Quality", "Smallest File Size"

// CARD EXPORT FUNCTIONS - This section is used if you want to setup a Card conversion export script to do things like convert DPS, Image Type (PNG or JPEG), or to remove or add bleed and export to individual card files
